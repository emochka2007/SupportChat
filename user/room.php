		<div class="col-lg-8">
			<div class="panel panel-default" style="height:50px;">
				...
				<div class="showme hidden" style="position: absolute; left:-120px; top:20px;">
					<div class="well">
						...
						?>
							<span>
								<?php
								//выгружаем определенную комнату
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					...
					?>
						<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span>Обратно</a>
					...
					?>
						...
						<a href="#leave_room" data-toggle="modal" class="btn btn-warning">Выйти из комнаты</a>
					<?php
					}
					?>
				</div>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					<div style="height:10px;"></div>
					<span style="margin-left:10px;">Добро пожаловать, ваша задача будет рассмотрена в течение 24 часов</span><br>
					<div style="height:10px;"></div>
